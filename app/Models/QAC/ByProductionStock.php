...
class ByProductionStock extends Model
{
    ...
    protected $casts = [
        'initial_palm_quantity' => 'decimal:3',
        'efb_fiber_percentage' => 'decimal:3',
        'efb_percentage' => 'decimal:3',
        'shell_percentage' => 'decimal:3',
        'efb_fiber_produced' => 'decimal:3',
        'efb_produced' => 'decimal:3',
        'shell_produced' => 'decimal:3',
        'efb_fiber_previous_balance' => 'decimal:3',
        'efb_previous_balance' => 'decimal:3',
        'shell_previous_balance' => 'decimal:3',
        'efb_fiber_sold' => 'decimal:3',
        'efb_sold' => 'decimal:3',
        'shell_sold' => 'decimal:3',
        'efb_fiber_other' => 'decimal:3',
        'efb_other' => 'decimal:3',
        'shell_other' => 'decimal:3',
        'efb_fiber_balance' => 'decimal:3',
        'efb_balance' => 'decimal:3',
        'shell_balance' => 'decimal:3',
    ];
