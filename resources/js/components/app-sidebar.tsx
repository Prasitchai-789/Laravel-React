...
const DevNavItems: NavItem[] = [
    ...
    { title: 'Dashboard Report', href: '/accounts/dashboard-report', icon: LayoutDashboard, permission: ['developer.view', 'gm.view', 'acc.view'] },
    { title: 'Business Performance', href: '/accounts/business-performance', icon: ChartNoAxesCombined, permission: ['developer.view', 'gm.view', 'acc.view'] },
    { title: 'งบทดลองเบื้องต้น', href: '/accounts', icon: CreditCard, permission: ['developer.view', 'gm.view', 'acc.view'] },
