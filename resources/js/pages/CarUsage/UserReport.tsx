...
import { User, Calendar, Gauge, TrendingUp, RefreshCw, Briefcase } from 'lucide-react';
...
export default function UserCarUsageReport() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20 p-4 font-anuphan">
                    ...
                    <div className="mb-6 rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-gray-800 lg:text-3xl">รายงานการใช้รถตามผู้ใช้</h1>
                                    <p className="mt-1 text-gray-600">สรุประยะทางการใช้รถแยกตามพนักงาน</p>
                                </div>
                            </div>
                            ...
                            <div className="rounded-xl bg-gradient-to-r from-emerald-50 to-green-50 p-4">
                                <div className="text-center">
                                    <p className="mb-1 text-sm font-medium text-emerald-700">ช่วงเวลาที่แสดง</p>
                        ...
                        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-xl border border-gray-300 px-4 py-3 transition-all hover:border-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200"
                                >
                            ...
                            <div className="sm:col-span-2 lg:col-span-2">
                                ...
                                <button
                                    onClick={fetchData}
                                    disabled={loading}
                                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 py-3 font-medium text-white shadow-lg transition-all hover:scale-[1.02] hover:from-emerald-600 hover:to-green-700 hover:shadow-xl active:scale-[0.98] disabled:opacity-50"
                                >
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div className="rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 p-6 text-white shadow-lg">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-emerald-100">จำนวนผู้ใช้รถ</p>
                                    <p className="mt-2 text-3xl font-bold">{formatNumber(summary.total_users)}</p>
                                    <p className="mt-1 text-emerald-100">คน</p>
                                </div>
                        ...
                        <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white shadow-lg">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-blue-100">จำนวนเที่ยวทั้งหมด</p>
                                    <p className="mt-2 text-3xl font-bold">{formatNumber(summary.total_trips)}</p>
                                    <p className="mt-1 text-blue-100">เที่ยว</p>
                                </div>
                                <div className="rounded-2xl bg-white/20 p-4 backdrop-blur-sm">
                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="text-xl font-semibold text-gray-800">
                                รายละเอียดการใช้รถแยกตามผู้ใช้
                            </h2>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="bg-gray-50">
                                            ...
                                            <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">แผนก</th>
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {data.map((item, index) => (
                                            <tr key={item.emp_id} className="hover:bg-emerald-50/50 transition-colors">
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <span className="font-medium text-gray-800">{item.emp_name}</span>
                                                            {item.emp_position !== '-' && (
                                                                <p className="text-xs text-gray-500">{item.emp_position}</p>
                                                            )}
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr className="bg-gradient-to-r from-emerald-50 to-green-50 font-semibold">
                                            <td colSpan={3} className="px-4 py-3 text-gray-700">รวมทั้งหมด</td>
                                            <td className="px-4 py-3 text-center text-blue-700">
                                                {formatNumber(summary.total_trips)}
                                            </td>
                                            <td className="px-4 py-3 text-right text-lg text-emerald-700">
