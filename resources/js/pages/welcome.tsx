...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-[#F0F8FF] via-[#E6F3FF] to-[#F5F9FF] p-6 text-[#1E3A8A] lg:justify-center lg:p-8 dark:from-[#0F172A] dark:via-[#1E293B] dark:to-[#334155]">
                    ...
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            ...
                            <>
                                ...
                                <Link
                                    href={route('register')}
                                    className="inline-block rounded-lg bg-gradient-to-r from-[#F59E0B] to-[#EAB308] px-5 py-2 text-sm leading-normal text-white transition-all hover:from-[#D97706] hover:to-[#CA8A04] shadow-md"
                                >
                                    Register
                                </Link>
                            </>
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col items-center lg:max-w-4xl">
                        ...
                        <div className="mb-10 flex flex-col items-center text-center">
                            ...
                            <h1 className="mb-3 text-3xl font-bold text-[#1E3A8A] dark:text-[#EFF6FF]">
                                Welcome to ISANPALM
                            </h1>
                            <p className="max-w-md text-lg text-[#475569] dark:text-[#CBD5E1]">
                                Build something amazing with our platform and its rich ecosystem.
                            </p>
                        </div>
                        {/* Quick Stats */}
                        <div className="mt-4 grid w-full grid-cols-2 gap-6 lg:grid-cols-4">
                            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-blue-50 p-6 text-center shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 border border-blue-100 dark:from-gray-800 dark:to-gray-900 dark:border-gray-700">
                                <div className="absolute -right-4 -top-4 h-16 w-16 rounded-full bg-gradient-to-br from-yellow-400 to-blue-500 opacity-10 group-hover:opacity-20 transition-opacity"></div>
                                <div className="relative z-10">
                                    ...
                                    <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent dark:from-blue-400 dark:to-blue-200 mb-2">
                                        10K+
                                    </div>
                        ...
                        {/* Content Cards */}
                        <div className="grid w-full gap-6 lg:grid-cols-2 mt-10">
                            {/* Getting Started Card */}
                            <div className="rounded-2xl bg-white p-8 shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all hover:shadow-[0_8px_30px_rgba(59,130,246,0.15)] border border-[#E0F2FE] dark:bg-[#1E293B] dark:border-[#334155]">
                                <h2 className="mb-4 text-xl font-semibold text-[#1E40AF] dark:text-[#E0F2FE]">
                                    เริ่มต้นใช้งาน
                                </h2>
                                <p className="mb-6 text-[#475569] dark:text-[#CBD5E1]">
                                    ระบบจัดการสวนปาล์มน้ำมันครบวงจรสำหรับเกษตรกรยุคใหม่
                                </p>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M9.25 8.35V3.35H4.25M2.5 9.6L9 3.00001"
                                                        stroke="currentColor"
                                ...
                                <div className="mt-8 pt-6 border-t border-[#E0F2FE] dark:border-[#334155]">
                                    <a
                                        href="/dashboard"
                                        className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#3B82F6] to-[#1D4ED8] px-5 py-2.5 text-sm font-medium text-white transition-all hover:from-[#2563EB] hover:to-[#1E40AF] shadow-md"
                                    >
                                        <svg
                                            width="16"
                                            height="16"
                            ...
                            <div className="rounded-2xl bg-gradient-to-br from-[#1E40AF] to-[#3B82F6] p-8 text-white">
                                ...
                                <p className="mb-6 text-[#E0F2FE]">
                                    กลุ่มธุรกิจปาล์มน้ำมันครบวงจรแห่งภาคอีสาน
                                </p>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 rounded-lg bg-white/10 p-3 backdrop-blur-sm transition-all hover:bg-white/15">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-[#E0F2FE]">
                                                ปลูกและดูแลสวนปาล์มน้ำมันคุณภาพสูง
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 rounded-lg bg-white/10 p-3 backdrop-blur-sm transition-all hover:bg-white/15">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-[#E0F2FE]">
                                                โรงงานสกัดน้ำมันปาล์มและแปรรูป
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="mt-8 grid w-full grid-cols-1 gap-6 lg:grid-cols-3">
                            <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white shadow-lg">
                                ...
                                <div className="text-2xl font-bold mb-2">5,000+ ไร่</div>
                                <div className="w-full bg-blue-400 rounded-full h-2">
                                    <div className="bg-white h-2 rounded-full w-4/5"></div>
                                </div>
                                <div className="text-xs text-blue-200 mt-2">เพิ่มขึ้น 15% จากปีที่แล้ว</div>
                            </div>
                            ...
                            <div className="rounded-2xl bg-gradient-to-br from-yellow-500 to-yellow-600 p-6 text-white shadow-lg">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-yellow-200">
                                        <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0" stroke="currentColor" strokeWidth="2" />
                                    </svg>
                                </div>
                                <div className="text-2xl font-bold mb-2">10,000+ ตัน</div>
                                <div className="w-full bg-yellow-400 rounded-full h-2">
                                    <div className="bg-white h-2 rounded-full w-3/4"></div>
                                </div>
                                <div className="text-xs text-yellow-200 mt-2">เพิ่มขึ้น 20% จากปีที่แล้ว</div>
                            </div>
                            ...
                            <div className="rounded-2xl bg-gradient-to-br from-green-500 to-green-600 p-6 text-white shadow-lg">
                                ...
                                <div className="text-xs text-green-200 mt-2">จากเกษตรกรในเครือ</div>
                            </div>
                        </div>
