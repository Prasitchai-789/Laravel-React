...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'รายงานการผลิต (ไล่ระบบ)', href: '#' },
];
...
export default function ProductionReport2() {
    ...
    const fetchSummary = async (dateParam?: string, isLatest = false) => {
        try {
            ...
            const res = await fetch(`/report/productions2/summary${query}`);
                ...
                <div className="mb-1 grid grid-cols-2 gap-2">
                    ...
                    <MobileSectionCard
                        ...
                        rows={[
                            ...
                            { label: 'ไล่ระบบ', value: fmt(prod?.loop_back), className: 'bg-red-100/60 text-red-700 font-bold' },
                    ...
                    <MobileSectionCardB
                        ...
                        rows={[
                            ...
                            },
                            {
                                ...
                                ffaColor: getQualityColor('ffa', prod?.ffa_cpo),
                                dobiColor: getQualityColor('dobi', prod?.dobi_cpo),
                            },
                            {
                                label: 'T2',
                                value: fmt(prod?.total_cpo),
                                ffa: fmt(prod?.ffa_cpo, 2),
                                dobi: fmt(prod?.dobi_cpo, 2),
                                className: 'bg-amber-50/70',
                                ffaColor: getQualityColor('ffa', prod?.ffa_cpo),
                                dobiColor: getQualityColor('dobi', prod?.dobi_cpo),
                            },
